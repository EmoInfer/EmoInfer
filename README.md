...
* By default, _EmoInfer_ visualizes the tracked face and the corresponding facial action units. For better speed when analyzing multiple videos, we suggest removing the options _-vis-track_ and _-vis-aus_ from the _FaceLandmarkVidMulti_ command present in the _'app.py'_ file.
